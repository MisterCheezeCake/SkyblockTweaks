...
public class CoordinatesHud extends TextHud {
    ...
    private CoordinatesHud() {
        ...
        line = new SingleHudLine(
                ...
                () -> Component.literal(String.format("X: %s Y: %s Z: %s" , NumberUtils.formattedRound(mc.player.getX(), SBTConfig.huds().coordinates.decimalPlaces), NumberUtils.formattedRound(mc.player.getY(), SBTConfig.huds().coordinates.decimalPlaces), NumberUtils.formattedRound(mc.player.getZ(), SBTConfig.huds().coordinates.decimalPlaces)))
        );
    }
